...
WORKDIR /src
COPY ["ToTheBlessing.csproj", "."]
RUN dotnet restore "./ToTheBlessing.csproj"
COPY . .
WORKDIR "/src/."
RUN dotnet build "./ToTheBlessing.csproj" -c $BUILD_CONFIGURATION -o /app/build

# Esta fase é usada para publicar o projeto de serviço a ser copiado para a fase final
FROM build AS publish
ARG BUILD_CONFIGURATION=Release
RUN dotnet publish "./ToTheBlessing.csproj" -c $BUILD_CONFIGURATION -o /app/publish /p:UseAppHost=true
